...
// TestEddsa25519VerifyRun tests the Run function of the precompile contract.
func TestEddsa25519VerifyRun(t *testing.T) {
	// Run tests.
...
func BenchmarkEddsa25519Verify(b *testing.B) {
	// Benchmark tests.
	for name, test := range tests {
