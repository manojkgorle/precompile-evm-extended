...
var (
	tests = map[string]testutils.PrecompileTest{
		"insufficient gas for generateRandomNumber should fail": {
			...
			InputFn: func(t testing.TB) []byte {
				...
				testInput = 0
				input, err := PackGenerateRandomNumber(testInput)
				require.NoError(t, err)
				return input
			},
			SuppliedGas: GenerateRandomNumberGasCost - 1,
			ReadOnly:    false,
...
// TestRandRun tests the Run function of the precompile contract.
